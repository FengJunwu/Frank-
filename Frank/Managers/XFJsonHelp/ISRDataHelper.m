    ...
    if (resultDic!= nil) {
        ...
        for (int i = 0; i < [wordArray count]; i++) {
            ...
            for (int j = 0; j < [cwArray count]; j++) {
                ...
                NSString *str = [NSString stringWithFormat:@"%@",[wDic objectForKey:@"id"]];
                [tempStr appendString: str];
            }
        }
        [dic setValue:[NSString stringWithFormat:@"%@",tempStr] forKey:@"KeywordID"];
        [dic setValue:[NSString stringWithFormat:@"%@",[resultDic objectForKey:@"sc"]] forKey:@"sc"];
    }
